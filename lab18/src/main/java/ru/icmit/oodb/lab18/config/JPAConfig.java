package ru.icmit.oodb.lab18.config;
...
@ComponentScan("ru.icmit.oodb.lab18")
@PropertySource("classpath:db.properties")
@EnableJpaRepositories("ru.icmit.oodb.lab18.repository")
public class JPAConfig {
    ...
    public EntityManagerFactory entityManagerFactory() {
        ...
        em.setPersistenceUnitName("lab18");
